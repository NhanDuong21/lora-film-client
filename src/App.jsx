...
import MovieDetailView from './pages/customer/MovieDetailPage';
import SeatSelectionView from './pages/customer/SeatSelectionPage';
import LoginView from './pages/auth/LoginPage';
import RegisterView from './pages/auth/RegisterPage';
import AdminLayout from './components/admin/AdminLayout';
import EmployeeLayout from './components/employee/EmployeeLayout';
import CustomerProfileView from './pages/customer/CustomerProfilePage';
import MovieDiscoveryView from './pages/customer/MovieDiscoveryPage';
import ActorRegistryView from './pages/admin/ActorRegistryPage';
import DirectorRegistryView from './pages/admin/DirectorRegistryPage';
import CinemaDetailView from './pages/customer/CinemaDetailPage';
import EventRegistryView from './pages/admin/EventRegistryPage';
import MasterBookingFunnel from './pages/customer/MasterBookingFunnelPage';
